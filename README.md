...
- `browse [limit] [filter] [word_to_filter]`: Show latest posts for current user, if wanting to use the filter option, the limit is mandatory. ONce ran, keep using "enter" to fetch more posts, or "q" to close the browsing session.
